...
mkdir -p $3
echo "building log"
git -C $1 log --all --numstat --date=short --pretty=format:'--%h--%ad--%aN' --no-renames --after=$2 > $3/logfile.log
...
echo "age"
docker run -v $3:/data -it code-maat-app -l /data/logfile.log -c git2 -a age > $3/age.csv
echo "author churn"
docker run -v $3:/data -it code-maat-app -l /data/logfile.log -c git2 -a author-churn > $3/author-churn.csv
echo "entity churn"
docker run -v $3:/data -it code-maat-app -l /data/logfile.log -c git2 -a entity-churn > $3/entity-churn.csv